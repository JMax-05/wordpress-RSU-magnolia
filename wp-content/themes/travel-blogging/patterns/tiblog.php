...
<div class="wp-block-column news-heading-inner-box" style="flex-basis:100%"><!-- wp:heading {"textAlign":"left","level":4,"className":"news-sec-heading has-lato-font-family"} -->
<h4 class="wp-block-heading has-text-align-left news-sec-heading has-lato-font-family"><strong><?php echo esc_html('Our Recent Blogs','travel-blogging'); ?></strong></h4>
<!-- /wp:heading --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<!-- wp:post-title {"level":5,"isLink":true,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|20","top":"var:preset|spacing|30"}},"typography":{"fontStyle":"thin","fontWeight":"700"}},"fontFamily":"lato"} /-->
